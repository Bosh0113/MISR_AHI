...
def record_roi_misr_ahi(roi_name, band_index, misr_orbit, misr_camera_index, ahi_obs_time, misr_hdf_filename, ahi_ac_npy, AHI2MISR_slope):
...
def get_roi_misr_ahi(roi_name, misr_path_orbit_camera, ahi_ac_npy):
    ...
    roi_misr_toa, roi_ahi_toa_misr = record_roi_misr_ahi(roi_name, band_index, misr_orbit, misr_camera_index, ahi_obs_time, misr_nc_filename, ahi_ac_npy, AHI2MISR_slope)
