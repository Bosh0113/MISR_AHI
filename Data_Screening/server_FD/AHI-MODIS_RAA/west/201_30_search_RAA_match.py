...
GRO_OBS_COND_TXT = 'MISR_GEO_RAA_MATCH_RECORD_W_10km_' + str(ulat_range) + '.txt'
...
def main():
    ...
    # record
    matched_record = []
    misr_raa_matched_npy_filename = os.path.join(WORK_SPACE, 'MISR_matched_record_west_10km_' + str(ulat_range) + '.npy')
