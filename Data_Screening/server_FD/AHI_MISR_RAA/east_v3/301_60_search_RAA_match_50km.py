...
GRO_OBS_COND_TXT = 'MISR_GEO_RAA_MATCH_RECORD_E_50km_' + str(ulat_range) + '.txt'
...
def main():
    ...
    # record
    matched_record = []
    misr_ray_matched_npy_filename = os.path.join(WORK_SPACE, 'MISR_matched_record_east_50km_' + str(ulat_range) + '.npy')

    point_locations_npy_filename = os.path.join(WORK_SPACE, 'FD_180e_50km_lonlat.npy')
