...
ws = r'E:\MISR_AHI_WS\230225'
ray_matched_record_npy = os.path.join(ws, 'AHI_MISR_Ray-matched_1mon.npy')
ray_matched_record_npy_50km = os.path.join(ws, 'AHI_MISR_Ray-matched_1mon_50km.npy')
