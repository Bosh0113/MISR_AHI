                                                ...
                                                for AHI_saa_filename_diff in AHI_saa_filename_diffs:
                                                    if not matched_flag:
                                                        ...
                                                        if os.path.exists(ahi_saa_bin_bz2):
                                                            m_vaa, ahi_vaa, m_saa, ahi_saa, m_raa, ahi_raa, diff_raa = misr_ahi_raa_matching(roi_geoj_filename, misr_nc_filename, ahi_vaa_bin, ahi_saa_bin, camera)
                                                            # ## RAA match ###
                                                            ...
                                                            if diff_raa > 0 and diff_raa < RAA_DEGREE_THRESHOLD:
                                                                ...
                                                                matched_roi_misr['matched_info'] = [
                                                                    ...
                                                                    int(ahi_obs_time), misr_roi_vza, ahi_roi_vza, misr_roi_vaa, ahi_roi_vaa, misr_roi_saa, ahi_roi_saa, misr_roi_raa, ahi_roi_raa, misr_roi_sza, ahi_roi_sza
                                                                ]
