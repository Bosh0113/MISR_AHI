...
GRO_OBS_COND_TXT = 'MISR_AHI_FULL_MATCH_RECORD_50km.txt'
...
def main():
    ...
    # record
    matched_record = []
    misr_vza_matched_npy_filename = os.path.join(WORK_SPACE, 'MISR_matched_record_50km.npy')

    # point_locations_npy_filename = os.path.join(loc_folder, misr_vza_str + '_point4search_' + str(ROI_DISTANCE) + '.npy')
    point_locations_npy_filename = '/disk1/workspace/20221103/MISR_FM/AHI_180_50km_onland_lonlat.npy'
