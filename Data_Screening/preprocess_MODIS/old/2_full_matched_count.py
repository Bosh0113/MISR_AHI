...
def get_full_matched_count(record_npy_filename):
    count_record_txt_filename = os.path.join(WORK_SPACE, 'MODIS_matched_record_10km_all_count.txt')
    info_record_str = ''
...
if __name__ == "__main__":
    record_npy_filename = os.path.join(WORK_SPACE, 'MODIS_matched_record_10km_all.npy')
