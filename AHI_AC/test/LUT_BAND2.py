...
def ac_band2(In_ozone, In_AOT, In_sza, In_vza, In_raa):

    wl_band = "/data/Projects/sixs_band2.csv"
...
start = time.time()
AC_output = Parallel(n_jobs=-1)(
    delayed(ac_band2)(In_ozone, In_AOT, In_sza, In_vza, In_raa)
...
X2 = X[:, 1]
X3 = X[:, 2]
outfile1 = "01_band2.csv"
outfile2 = "02_band2.csv"
outfile3 = "03_band2.csv"
