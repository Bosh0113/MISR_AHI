...
AHI2MISR_SBAF = {   # slope, offset
    '7_band3': [1.146, -0.004738],   # Open Shrublands
    '7_band4': [1.012, -0.0005396],
}
            ...
            for month_idx in range(len(MONTH_LABEL)):
                ...
                for folder_l2 in folder_l2_list:
                    ...
                    for roi_folder in roi_folder_list:
                        ...
                        roi_lc = roi_infos[1]
                        if roi_lat < 0 and roi_lc == lc_type:
                            ...
                            for roi_file in roi_file_list:
                                ...
                                if matchObj:
                                    ...
                                    if obs_month_idx == month_idx:
                                        ...
                                        ahi_sr = ROI_SR_pair['ahi_sr']
                                        AHI2MISR_para = AHI2MISR_SBAF[roi_lc + '_band' + band_str]
                                        ahi_sr = ahi_sr2misr_sr(ahi_sr, AHI2MISR_para)
