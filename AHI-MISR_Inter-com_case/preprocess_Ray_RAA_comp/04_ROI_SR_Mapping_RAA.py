...
def get_roi_cloudmask_list(cloudmask_fd, roi_ct):
    ...
    ahi_lats = numpy.arange(60. - CM_RESOLUTION / 2, -60, -CM_RESOLUTION)
    ahi_lons = numpy.arange(85. + CM_RESOLUTION / 2, 205, CM_RESOLUTION)
                            ...
                            for band_name in band_names:
                                ...
                                for roi_misr_info in roi_misr_infos:
                                    ...
                                    if os.path.exists(ahi_ac_npy):
                                        roi_ct = [roi_lat, roi_lon]
                                        is_clearsky = roi_is_clearsky(str(ahi_obs_time), roi_ct)
                                        if is_clearsky:
