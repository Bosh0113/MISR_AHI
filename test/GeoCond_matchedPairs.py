...
sat_data_path = '/data/beichen/data/MISR_AHI_ROIs_RAA'
matched_record_path = '/data/beichen/workspace/20220314/VZA001_RAA3_SZAt_c5.npy'
...
if __name__ == "__main__":
    ...
    for roi_matched in matched_record:
        ...
        for misr_ahi_item in misr_ahi:
            ...
            raa_record_npy = os.path.join(misr_folder_path,
