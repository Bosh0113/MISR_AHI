...
ws = os.getcwd()
npy_filename = os.path.join(ws, 'ABI18_50km_onland.npy')
lonlat_npy_filename = os.path.join(ws, 'ABI18_50km_onland_lonlat.npy')
...
if __name__ == "__main__":
    ...
    ahi_lons = numpy.arange(-180. + INTERNAL_DEGREE / 2, -77, INTERNAL_DEGREE)
