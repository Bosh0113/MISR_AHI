...
AHI_VZA_BIN = WORK_SPACE + '/ABI18_VZA.npy'
AHI_VAA_BIN = WORK_SPACE + '/ABI18_VAA.npy'

GRO_OBS_COND_TXT = 'MISR_ABI18_RAY_MATCH_RECORD_50km.txt'
...
def main():
    ...
    point_locations_npy_filename = os.path.join(WORK_SPACE, 'ABI18_50km_onland_lonlat.npy')
