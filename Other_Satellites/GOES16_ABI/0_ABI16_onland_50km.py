...
ws = os.getcwd()
npy_filename = os.path.join(ws, 'ABI16_50km_onland.npy')
lonlat_npy_filename = os.path.join(ws, 'ABI16_50km_onland_lonlat.npy')
...
if __name__ == "__main__":
    ...
    ahi_lons = numpy.arange(-138. + INTERNAL_DEGREE / 2, -18, INTERNAL_DEGREE)
