...
AHI_VZA_BIN = WORK_SPACE + '/ABI16_VZA.npy'
AHI_VAA_BIN = WORK_SPACE + '/ABI16_VAA.npy'

GRO_OBS_COND_TXT = 'MISR_ABI16_RAY_MATCH_RECORD_50km.txt'
...
def main():
    ...
    point_locations_npy_filename = os.path.join(WORK_SPACE, 'ABI16_50km_onland_lonlat.npy')
