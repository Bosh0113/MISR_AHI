...
AHI_VZA_BIN = WORK_SPACE + '/AMI_VZA.npy'
AHI_VAA_BIN = WORK_SPACE + '/AMI_VAA.npy'

GRO_OBS_COND_TXT = 'MISR_AMI_RAY_MATCH_RECORD_50km.txt'
...
def main():
    ...
    point_locations_npy_filename = os.path.join(WORK_SPACE, 'AMI_180_50km_onland_lonlat.npy')
