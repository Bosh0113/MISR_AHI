...
ws = os.getcwd()
npy_filename = os.path.join(ws, 'AMI_180_50km_onland.npy')
lonlat_npy_filename = os.path.join(ws, 'AMI_180_50km_onland_lonlat.npy')

INTERNAL_DEGREE = 0.5   # 50km

if __name__ == "__main__":
    start = time.perf_counter()
    ahi_lats = numpy.arange(60. - INTERNAL_DEGREE / 2, -60, -INTERNAL_DEGREE)
    ahi_lons = numpy.arange(69. + INTERNAL_DEGREE / 2, 180, INTERNAL_DEGREE)    # 只东半球
