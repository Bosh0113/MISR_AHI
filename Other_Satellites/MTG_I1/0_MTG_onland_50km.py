...
ws = os.getcwd()
npy_filename = os.path.join(ws, 'MTG_50km_onland.npy')
lonlat_npy_filename = os.path.join(ws, 'MTG_50km_onland_lonlat.npy')
...
if __name__ == "__main__":
    ...
    ahi_lons = numpy.arange(-60. + INTERNAL_DEGREE / 2, 60, INTERNAL_DEGREE)
